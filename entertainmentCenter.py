...
burnAfterReading = media.Movie("Burn After Reading",
...
batmanVSSuperman = media.Movie("Batman V.S. Superman",
...
SuckerPunch = media.Movie ("Suckerpunch",
...
movies = [inception, interstellar, burnAfterReading, fargo, batmanVSSuperman, SuckerPunch]
